...
COMPUTED_STYLE_PROP(background_repeat_x,           BackgroundRepeatX)
COMPUTED_STYLE_PROP(background_repeat_y,           BackgroundRepeatY)
...
COMPUTED_STYLE_PROP(mask_repeat_x,                 MaskRepeatX)
COMPUTED_STYLE_PROP(mask_repeat_y,                 MaskRepeatY)
